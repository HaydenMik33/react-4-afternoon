  ...
  render() {
    return (
      <div>
        ...
        <Link to="/about" className="subnav-links"><h3>About</h3></Link>
        <Link to="/about/history" className="subnav-links"><h3>History</h3></Link>
        <Link to="/about/contact" className="subnav-links"><h3>Contact</h3></Link>        
        </div>
